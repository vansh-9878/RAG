        ...
        resultCard.innerHTML = `
            <div class="mb-4">
                <h3 class="text-lg font-semibold text-gray-800 mb-2">
                    <i class="fas fa-question-circle mr-2 text-blue-500"></i>Question ${index + 1}
                </h3>
                <p class="text-gray-700 bg-blue-50 p-3 rounded-lg border-l-4 border-blue-400">${escapeHtml(question)}</p>
            </div>
            <div>
...
function saveFormData() {
    const formData = {
        ...
        questions: Array.from(document.querySelectorAll('.question-input')).map(input => input.value),
